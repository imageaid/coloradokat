class PhotoSetsController < ApplicationController
  ...
  def create
    ...
    if @photo_set.save
      redirect_to @photo_set, notice: "Photo set was successfully created."
    else
  ...
  def update
    if @photo_set.update(photo_set_params)
      redirect_to @photo_set, notice: "Photo set was successfully updated.", status: :see_other
    else
  ...
  def destroy
    @photo_set.destroy!
    redirect_to photo_sets_url, notice: "Photo set was successfully destroyed.", status: :see_other
  end
